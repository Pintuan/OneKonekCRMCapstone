      ...
      <div className="w-full max-w-xl p-6 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end mt-6">
            <button className="px-6 py-3 text-base font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
              Submit
            </button>
          </div>
        </form>
