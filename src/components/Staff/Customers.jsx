...
function Customers() {
  ...
  return (
    <main className="grow">
      ...
      <div className="sm:flex sm:justify-between sm:items-start mb-8 w-full">
  <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    {/* Button container for large screens */}
    <div className="flex justify-end mb-4 sm:mb-0 mr-4">
    ...
    {/* Title and Cards */}
    <div>
      <h1 className="text-lg font-lg text-gray-800 dark:text-white font-bold">
        Customers
      </h1>
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        {/* Accept Payment button for smaller screens */}
